...
(function(h) {
  ...
  function rb(a) {
    var b = a.oClasses,
      ...
      e = a.oPreviousSearch,
      f = a.aanFeatures,
      g = '<input type="search" class="' + b.sFilterInput + '"/><a href="#">クリア</a>',
      j = d.sSearch,
  ...
  m.defaults = {
    ...
    oLanguage: {
      ...
      oPaginate: { sFirst: "First", sLast: "Last", sNext: "次へ", sPrevious: "前へ" },
      sEmptyTable: "No data available in table",
      sInfo: "表示 _START_ ~ _END_ / _TOTAL_ 件表示",
      sInfoEmpty: "表示 0 ~ 0 / 0 件表示",
      sInfoFiltered: "(filtered from _MAX_ total entries)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "表示 _MENU_ 件表示",
