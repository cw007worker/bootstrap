...
$(document).ready(function() {
  ...
  if (device_height < 750) {
    $(".sticky-header .sidebar-left").css("position", "absolute");
  }
  $(window).resize(function() {
    var device_height = $(window).height();
    if (device_height < 750) {
      ...
      $(".sticky-header .sidebar-left").css("position", "fixed");
    }
  });

  $(".user_info_modal").load("user_info_modal.html", function() {});
  $(".rehabilitarion_used_user_info_modal").load("rehabilitarion_used_user_info_modal.html", function() {});
  $(".rehabilitation_user_register_info_modal").load("rehabilitation_user_register_info_modal.html", function() {});

  $('#menu_checkbox').prop('checked', false);
  $("#menu_checkbox").click(function() {
    $(".fixed_side_menu").toggleClass("active");
    $(".contents_wrap").toggleClass("active");
  });
  $(".mega-menu ul ul li a").click(function() {
    $normal_val = $(this).text();
    $(".mega-menu .navbar-nav>li>a").html($normal_val + '<i class="mdi mdi-chevron-down"></i>');
  });

  if ($('.bath_regist_check').is(':checked')) {
